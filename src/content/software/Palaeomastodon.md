...
order: 3
lang: en
icon: ./Palaeomastodon.png
iconLarge: ./Palaeomastodon@8x.png
summary: A social client (Mastodon) for Mac OS 9.
download: /software/Palaeomastodon/Palaeomastodon-1.1.0.sit
version: 1.1.0
---
...
![A post in Palaeomastodon](./Palaeomastodon-screenshot.png "Palaeomastodon screenshot")
